...
const Dashboard = () => {
  ...
  return (
    <div className='min-h-screen bg-white font-mono'>
        <div className='w-[90%] sm:w-[70%] md:w-[60%] lg:w-[50%]  mx-auto text-black flex flex-col gap-2 py-6'>
            <div className='flex justify-between items-center'>
            <span className='font-semibold'>Dashboard</span>
            <span className='font-semibold'> { loginInf.nikName } </span>
            </div>
            <div className='flex flex-col gap-4 bg-gradient-to-br bg-black/10 rounded-2xl p-6'>
                <div className='flex justify-between items-center'>
                    <div>
                    ...
                    <div>                        
                        <button onClick={()=>setopenAddMoney(true)} className='flex items-center gap-2 px-4 py-2 bg-black/20 cursor-pointer hover:bg-green-700 transition-all duration-500 active:scale-95'> <PiUploadDuotone /> Add </button>
                    </div>
                </div>
        ...
        <div className='w-[90%] sm:w-[70%] md:w-[60%] lg:w-[50%] mx-auto text-black flex flex-col gap-4 py-6'>
            <div className='flex justify-between items-center'>
            <span className='font-semibold'>Recent transactions</span>
                <div onClick={categoryFilter} className='flex justify-center items-center gap-2 sm:gap-4'>
                    <button className={`${categoryData === "ALL" ? 'scale-90' : 'scale-100'} px-2 py-1 text-sm sm:text-base sm:px-4 sm:py-1 bg-black/40 rounded-md hover:bg-blue-700  cursor-pointer transition-all duration-500 ease-in`}>All</button>
                    <button className={`${categoryData === "INCOME" ? 'scale-90' : 'scale-100'} px-2 py-1 text-sm sm:text-base sm:px-4 sm:py-1 bg-black/40 rounded-md hover:bg-green-700 cursor-pointer transition-all duration-500 ease-in `}>Income</button>
                    <button className={`${categoryData === "EXPANSE" ? 'scale-90' : 'scale-100'} px-2 py-1 text-sm sm:text-base sm:px-4 sm:py-1 bg-black/40 rounded-md hover:bg-red-700 cursor-pointer transition-all duration-500 ease-in`}>Expanse</button>
                </div>
