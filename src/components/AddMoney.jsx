...
const AddMoney = ({openAddMoney, setopenAddMoney}) => {
  ...
  return (
    <div className='text-white fixed inset-0 py-10 flex flex-row-reverse gap-2 justify-center backdrop-blur-sm z-50'> 
        ...
        <form onSubmit={handleFormSubmit} className='h-[300px] w-[300px] sm:h-80 sm:w-[400px] bg-gradient-to-tr to-red-600 from-black rounded-2xl p-10 flex flex-col gap-6'>
            <select onChange={handleInputChange} name='category' value={expData.category} className='border border-white/40 w-full p-1 rounded-md focus-within:border-blue-600 outline-none text-sm cursor-pointer transition-all duration-300 ease-linear'>
            ...
            <div className='relative mt-4'> 
                ...
                <label htmlFor="expanseName" className='absolute left-1 -top-3.5 text-white/50 text-[12px]  peer-placeholder-shown:top-2 transition-all duration-500 peer-focus:-top-3.5 peer-focus:text-white' > Enter Expanse </label>
            </div>
            ...
            <div className='relative mt-2'>
                ...
                <label htmlFor="expanseAmount" className='absolute left-1 -top-3.5 text-[12px] text-white/50 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-white  transition-all duration-500' > Enter Amount </label>
            </div>
